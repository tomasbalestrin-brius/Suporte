-- ============================================
-- SCHEMA COMPLETO DO SISTEMA DE SUPORTE
-- ============================================
...
-- Tabela de tickets (COM NOVOS CAMPOS)
CREATE TABLE IF NOT EXISTS public.tickets (
  ...
  -- Novos campos para tickets públicos
  customer_name TEXT,
  customer_email TEXT,
  customer_cpf TEXT,
  product TEXT,
...
-- Tabela de Base de Conhecimento (NOVA)
...
-- Função para atualizar updated_at timestamp
...
-- ============================================
-- 4. DESABILITAR RLS (SEM AUTENTICAÇÃO)
-- ============================================
...
COMMENT ON COLUMN public.tickets.customer_name IS 'Nome do cliente (para tickets públicos sem autenticação)';
COMMENT ON COLUMN public.tickets.customer_email IS 'Email de compra do cliente';
COMMENT ON COLUMN public.tickets.customer_cpf IS 'CPF do cliente';
COMMENT ON COLUMN public.tickets.product IS 'Produto adquirido pelo cliente';
